...
export function UiSettingsModal({
  ...
  const saveSettings = async () => {
    ...
    if (settings.headerFont)
      root.style.setProperty('--font-display', settings.headerFont);
    ...
    if (settings.headerTitleColor)
      root.style.setProperty('--header-title-color', settings.headerTitleColor);
    ...
    <div className="fixed right-0 top-0 bottom-0 w-80 bg-white/90 backdrop-blur-md shadow-[-4px_0px_0px_rgba(0,0,0,1)] z-[10000] flex flex-col animate-in slide-in-from-right-full duration-300">
      ...
      <div className="p-5 flex-1 overflow-y-auto flex flex-col gap-6 bg-white/50 text-primary hide-scrollbar">
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-2">
            ...
            {settings.bgImage && (
              <>
                <div
                  className="h-24 w-full rounded-lg mt-1"
                  style={{
                      ...
                      settings.bgImageStyle === 'pattern-sm'
                        ...
                        : settings.bgImageStyle === 'pattern-md'
                          ...
                          : settings.bgImageStyle === 'pattern-lg'
                            ? '100px'
                            : 'cover',
                    backgroundRepeat: settings.bgImageStyle?.startsWith(
                      'pattern'
                    )
                      ? 'repeat'
                      : 'no-repeat',
          ...
          <div className="flex items-center justify-between">
            <label htmlFor="header-title-color" className="font-bold text-[0.8125rem]">
              Màu chữ Tiêu đề (Header Title)
            </label>
            <input
              id="header-title-color"
              type="color"
              value={settings.headerTitleColor || '#513229'}
              onChange={(e) =>
                setSettings({ ...settings, headerTitleColor: e.target.value })
              }
              className="w-10 h-10 cursor-pointer border-2 border-primary rounded-lg p-0.5 shadow-hard-sm"
            />
          </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-1">
            <label className="font-bold text-[0.8125rem]">
              Font chữ Tiêu đề (Header Font)
            </label>
            <select
              value={settings.headerFont || "'Bebas Neue', sans-serif"}
              onChange={(e) =>
                setSettings({ ...settings, headerFont: e.target.value })
              }
              className="w-full border-2 border-primary rounded-lg p-2 font-bold text-sm outline-none focus:shadow-hard-sm transition-all bg-white"
            >
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="sidebar-pos" className="font-bold text-[0.8125rem]">
              Vị trí Sidebar Menu
            </label>
            <select
              id="sidebar-pos"
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="border-radius" className="font-bold text-[0.8125rem]">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center justify-between">
              <label htmlFor="dark-mode" className="font-bold text-[0.8125rem]">
